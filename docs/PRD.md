...
> **팀**: Indigode — Bluenode 학회(인하대, 2023년 결성) 멤버로 구성된 한국 XRPL 결제 도전팀. 외부 영입 0명, 학회 100% 구성.
...
| | Ripple Payments | CoinPayments / FriiPay | t54.ai x402 Facilitator | **PayKit (Indigode)** |
|---|---|---|---|---|
...
- **이름의 의미**: Indigode = Verified + Dot — "검증된 마이크로 결제 단위"
...
| 14-slide 사업계획서 (본인 작성) | `/Users/arkstar/Projects/kfip/KFIP2026_Indigode_PayKit_사업계획서.md` |
...
**Indigode** · KFIP 2026 · 100% Bluenode 학회 구성
