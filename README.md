...
**Maintained by Bluenode** — 인하대학교 블록체인 학회 (2023년 결성, 현재 운영 3년차).

- **Lead / Founder**: Bluenode 학회장 (2026년~ 현 임기, XRPL EVM Sidechain 앱 개발 경험 보유)
- **운영 trace**: BUIDL Asia 2026 참여, 국내 블록체인 학회·해커톤 활동 다수
- **개발 풀**: Bluenode 학회 산하 인디 개발자 + 한국 블록체인 학회 연합 network
- **포지셔닝**: 한국 XRPL 결제 표준화 grass-roots 운영체 — 학회 internal 베타 use case(행사 결제·굿즈 정산·해커톤 상금)로 MVP 검증 + design partner pipeline

**Why this team can ship**:
- 학회장이 **XRPL EVM Sidechain 앱 개발 경험을 직접 보유** → v2.0 (6–18개월) XRPL EVM Sidechain 표면 합류는 실작동 코드 기반 단축 timeline
- 학회 산하 학생 개발자 풀로 본선 6주 동안 MVP 코어 빌딩 capacity 확보
- 한국 XRPL 커뮤니티 코어에서 출발 → XRPL Korea / Ripple Korea / t54.ai와 연결 가능한 native network
