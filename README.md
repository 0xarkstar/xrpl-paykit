...
**Live 5-scenario suite (2026-05-17)** — `pnpm tsx examples/testnet-live-suite.ts` (auto-funds wallets via faucet, no env vars). All 5 scenarios behave as designed on real XRPL testnet:
